...
{
    public partial class ElectrakDual : Form, ItrashCANPlugin
    {
        ...
        void ConnectToPCAN()
        {
            try
            {
                ...
                if (stsResult == TPCANStatus.PCAN_ERROR_OK)
                {
                    ...
                    ConnectButton.BackgroundImage = global::ElectrakDual.Properties.Resources.disconnect;
                    USBChannelCB.Enabled = false;
                    BAUDRateCB.Enabled = false;
                    RefreshButton.Enabled = false;
                    RefreshButton.BackgroundImage = global::ElectrakDual.Properties.Resources.refresh_gray;
                    ClearStatistics();
            ...
            catch (Exception Ex)
            {
                ...
                ConnectButton.BackgroundImage = global::ElectrakDual.Properties.Resources.connect;
                USBChannelCB.Enabled = true;
                BAUDRateCB.Enabled = true;
                RefreshButton.Enabled = true;
                CheckForAvailableChannels();
                RefreshButton.BackgroundImage = global::ElectrakDual.Properties.Resources.refresh;
